...
export default function NewArrivals() {
  ...
  const [bookingProduct, setBookingProduct] = useState<typeof products[0] | null>(null);
              ...
              <div className="group relative bg-[var(--card)] rounded overflow-hidden border border-[var(--border)] hover:shadow-2xl hover:shadow-[var(--primary)]/5 transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="p-2.5 md:p-4">
                  ...
                  <button
                    ...
                    className="w-full bg-[var(--primary)] text-white py-1.5 md:py-2.5 rounded md:rounded text-[10px] md:text-sm font-medium hover:opacity-90 transition-all hover:shadow-lg hover:shadow-[var(--primary)]/30 transform hover:scale-[1.02] duration-300 flex items-center justify-center gap-1.5 md:gap-2 group">
